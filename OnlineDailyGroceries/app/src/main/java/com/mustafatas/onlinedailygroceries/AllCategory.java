...
import com.mustafatas.onlinedailygroceries.adapter.AllCategoryAdapter;
import com.mustafatas.onlinedailygroceries.model.AllCategoryModel;
...
public class AllCategory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        allCategoryModelList.add(new AllCategoryModel(3, R.drawable.ic_juice));
        ...
        allCategoryModelList.add(new AllCategoryModel(8, R.drawable.ic_juice));
